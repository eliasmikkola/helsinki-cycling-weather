...
const drawHousesAndTrees = (context, data_to_draw, offset) => {
  ...
  for (var i = 0; i < 1; i++) {
    ...
    context.fillText("🏠",offset+10 , 15+100+100*i+height_adjust-30)
    context.fillText("🏠",offset+ 80 , 100+100*i+height_adjust-40)
    context.fillText("🏠",offset+ 40 , 15+100+100*i+height_adjust-50)
    
    context.fillText("🏠",offset+10 , 15+100+100*i+height_adjust)
    context.fillText("🏠",offset+ 80 , 100+100*i+height_adjust)
    context.fillText("🏠",offset+ 40 , 15+100+100*i+height_adjust)
    context.fillText("🏤",offset+ 500 , 100+100*i+height_adjust)
    context.font = "50px Arial"
    context.fillText("🏝",offset+ 300 , 10+100*i+height_adjust)
    context.fillText("🏝",offset+ 270 , 10+100*i+height_adjust)
    context.fillText("🏝",offset+ 285 , 15+100*i+height_adjust)
    context.font = "40px Arial"
    context.fillText("🏢",offset+ 295 , 0+65*i+height_adjust-5)
    context.fillText("🏢",offset+ 275 , 5+100*i+height_adjust)
    context.fillText("🌲",offset+ 295 , 7+100*i+height_adjust)
    context.fillText("🌲",offset+ 285 , 7+100*i+height_adjust)
    context.font = "100px Arial"

    context.fillText("🏢",offset+ 400 , 100+100*i+height_adjust-20)
    context.fillText("🏢",offset+ 350 , 100+100*i+height_adjust-30)
    context.fillText("🏢",offset+ 450 , 100+100*i+height_adjust-40)
    context.fillText("🏢",offset+ 400+100 , 100+100*i+height_adjust+10)
    context.fillText("🏢",offset+ 350+120 , 100+100*i+height_adjust)
    context.fillText("🏢",offset+ 450+150 , 100+100*i+height_adjust+5)
    context.fillText("🏬",offset+ 460 , 10+100+100*i+height_adjust)
    context.fillText("🏢",offset+ 420 , 20+100+100*i+height_adjust)
    context.fillText("🏨",offset+ 600 , 100+100*i+height_adjust)
    context.font = "100px Arial"
    context.fillText("🏭",offset+ 800 , 50+height_adjust)
    context.font = "140px Arial"
    context.fillText("🏛",offset+ 650 , 120+height_adjust)
    // flip text element
  }
